...
#plot1
plot(date_time, globalactive, type = "l", xlab = "", ylab = "Global Active Power")
#plot2
...
#plot3
plot(date_time, subpower$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
#plot4
plot(date_time, subpower$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()